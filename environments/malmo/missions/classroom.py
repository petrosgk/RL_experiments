...
class Classroom(Mission):
  def __init__(self, ms_per_tick):
              ...
              <AgentSection mode="Survival">
                ...
                <AgentHandlers>
                  ...
                  <AgentQuitFromTouchingBlockType>
                    <Block type="gold_block diamond_block redstone_block" 
    ...
    super(Classroom, self).__init__(mission_name=mission_name, agent_names=agent_names,
...
class ClassroomEnvironment(MissionEnvironment):
  def __init__(self, action_space, mission_name, mission_xml, remotes, state_builder, role=0,
    ...
    if action_space == 'discrete':
      actions = ['move 1', 'move -1', 'turn 0.5', 'turn -0.5']
    ...
    super(ClassroomEnvironment, self).__init__(mission_name, mission_xml, actions, remotes,
                                               state_builder,
