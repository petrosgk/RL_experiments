from environments.malmo.malmopy.environment.malmo import MalmoEnvironment, MalmoStateBuilder
...
class MissionEnvironment(MalmoEnvironment):
  def __init__(self, mission_name, mission_xml, actions, remotes, state_builder, role=0,
               turn_based=False,
    ...
    super(MissionEnvironment, self).__init__(mission_xml, actions, remotes, role=role,
